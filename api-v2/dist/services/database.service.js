...
function connectToDatabase() {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        const articleCollection = db.collection(process.env.COLLECTION_NAME_PRODUCTS);
        const userCollection = db.collection(process.env.COLLECTION_NAME_USERS);
        exports.collections.articles = articleCollection;
